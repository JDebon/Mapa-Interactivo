geocodificadorModulo = (function() {
    ...
    function usaDireccion(geocodificador, direccion, funcionALlamar) {
        ...
        let callback = function(GeocoderResult, GeocoderStatus) {
            if (GeocoderStatus == "OK") {
                funcionALlamar(direccion, GeocoderResult[0].geometry.location);
            } else {
                console.log("Ha ocurrido un error:" + GeocoderStatus);
            }
        }
        geocodificador.geocode(GeocoderRequest, callback.bind(this));
    }
